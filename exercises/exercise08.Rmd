...
r.bel.gls <- gls(NURSING ~ BOUTS + LOCKONS + DAYNIGHT + PERIOD, data = d.beluga,
                 correlation = 
                   corARMA(form = ~PERIOD, p = r.burg$order, q = 0, fixed = FALSE), 
                 method = "ML")
summary(r.bel.gls)
